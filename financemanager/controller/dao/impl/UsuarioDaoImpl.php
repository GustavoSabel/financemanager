...
class UsuarioDaoImpl implements DAO {
	...
	public function buscar($identificador) {
		$result = geraQuery ( "select " . Usuario::$CAMPO_IDUSUARIO . ", " . Usuario::$CAMPO_NOME . ", " . Usuario::$CAMPO_LOGIN . ", " . Usuario::$CAMPO_SENHA . " from " . Usuario::$TABELA . " where " . Usuario::$CAMPO_LOGIN . " = '" . $identificador . "'" );
	...
	public function listarTodos() {
		$result = geraQuery ( "select " . Usuario::$CAMPO_IDUSUARIO . ", " . Usuario::$CAMPO_NOME . ", " . Usuario::$CAMPO_LOGIN . ", " . Usuario::$CAMPO_SENHA . " from " . Usuario::$TABELA );
		return $result;
	}
